...
/**
 * DOM utils module, return a jQuery compatible API.
 *
 * @module hr/dom
 */
define('hr/dom',[
...
define('utils/hash',[],function () {
    ...
    return {
            ...
            'hex32': hex32,
            'atob': function(s) {
                return UTF8ArrToStr(base64DecToArr(s));
            },
            'btoa': function(s) {
                return base64EncArr(strToUTF8Arr(s));
            }
    };
});
define('backends/api',[
...
define('collections/repositories',[
    "hr/hr",
    "hr/utils",
    "hr/promise",
    "backends/api",
...
define('views/repositories',[
    ...
    "text!resources/templates/items/repository.html"
...
define('text!resources/templates/items/issue.html',[],function () { return '<div class="image">\n    <img src="<%- issue.get("user.avatar_url") %>" />\n</div>\n<% if (issue.get("comments") > 0) { %>\n    <div class="badge"><%- issue.get("comments") %></div>\n<% } %>\n<div class="infos">\n    <h2><%- issue.get("title") %></h2>\n    <p>#<%- issue.get("number") %> opened <%- $date.relative(issue.get("created_at")) %> by <a href="<%- issue.get("user.html_url") %>" target="_blank"><%- issue.get("user.login") %></a></p>\n\n    <div class="labels">\n    <% _.each(issue.get("labels"), function(label) { %>\n        <span class="label" style="background: #<%- label.color %>"><%- label.name %></span>\n    <% }); %>\n    </div>\n</div>';});
